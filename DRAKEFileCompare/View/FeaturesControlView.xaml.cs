...
{
    /// <summary>
    /// Interaction logic for FeaturesControlView.xaml
    /// </summary>
    public partial class FeaturesControlView : UserControl
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FeaturesControlView"/> class.
        /// </summary>
        public FeaturesControlView()
        {
            InitializeComponent();
        }
    }
